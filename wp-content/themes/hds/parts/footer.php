		...
		<div class="footer-grid">
			...
			<div class="footer-column">
				...
				<div class="footer-contact">
					...
					<a href="<?php echo esc_url( 'https://www.facebook.com/helderduidelijkschoon/' ); ?>" class="footer-contact__social" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e( 'Volg ons op Facebook', 'hds' ); ?>">
